...
#'@export
map_pi_rho_nonnull2 <- function(X, mix_grid, sigma_g, qalpha, qbeta,
  ...
  li_func <- function(args=c(z, gamma, eta, q)){
    z <- args[1]
    gamma <- args[2]
    eta <- args[3]
    q <- args[4]
