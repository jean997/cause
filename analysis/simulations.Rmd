...
These instructions specifically generate the results presented in [our paper](https://www.biorxiv.org/content/10.1101/682237v3). However, by modifying the dsc files, you can run your own experiments. We will describe the dsc files later on this page. To set up the analysis create a working directory that you will run the simulations in. Make sure all the software in the previous section is installed.
